...
import Grafiskprofil from "./Grafiskprofil";
        ...
        <div className="navbar">
          ...
          <nav className="navbar-nav">
            <ul className="navbar-list">
              <Link className="navlink list-link " to="/">
                <li className="list-a">Hem</li>
              </Link>
              <Link className="navlink list-link " to="/grunderna">
                <li className="list-a">Grunderna</li>
              </Link>
              <Link className="navlink list-link " to="/lärdig">
                <li className="list-a">Lär dig</li>
              </Link>
              <Link className="navlink list-link " to="/historia">
                <li className="list-a">Historia</li>
              </Link>
              <Link className="navlink list-link " to="/grafiskprofil">
                <li className="list-a">Grafiskprofil</li>
              </Link>
            </ul>
          </nav>
        ...
        <div className="footer">
          <div className="left-footer">
            ...
            <div className="contact-container">
              <p>Kontakta oss</p>
              <MdPhoneInTalk className="smallicon" />{" "}
              <RiMailSendFill className="smallicon" />
            </div>
          </div>
